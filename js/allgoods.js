$(function(){
	//商品列表动态添加
	$.getJSON("json/allgoods.json",goodsData);
	function goodsData(data){
		...
		for(var i = 0;i<data.length;i++){
				...
				'</li><li class="point"><span class="zero">.00</span>/'+data[i].goodsType+
				'</li></ul><div class="sub"><a href="http://localhost/breaktalk/goodscar.html" class="buy">立即购买</a><a href="'+data[i].goodsMessage+'" title="" target="_blank" class="check">查看详情</a></div></div></div></div>');
